        ...
        for i in range(120, length, 1):
            ...
            if 보유수량 == 0:
                ...
                if ma60 > ma120 and ma5_1 < ma60_1 and ma5 > ma60: # 60일선과 120일선이 정배열, 5일선이 60일선을 상향돌파할 때
                    ...
                    진입당최대수익 = 0
                    TS최대수익 = 0
                    result_df.loc[-1] = ['콜 진입', 일자, 진입가격, 보유수량, 0, 0, 0, round(누적손익,2)]
                    result_df.index += 1
                    pass
            else:
                청산가 = 종가
                ...
                if 보유수량 > 0 and ma5 < ma60 and ma20 < ma60: # 콜 청산 조건 체크: 5일선과 20일선 모두 60일선 아래로 떨어질 때
                    청산명 = '이평청산'
                else:
                    if 청산손익 <= -4: # 손절
                        청산명 = '손절'
...
+----------+----------+--------+----------+--------+----------+--------------+--------------+
| 콜 진입  | 20190402 | 282.5  |    1     |  0.0   |    0     |     0.0      |     0.0      |
|  TS청산  | 20190418 | 282.5  |    0     | 286.5  |    1     |     4.0      |     4.0      |
| 콜 진입  | 20191212 | 285.0  |    1     |  0.0   |    0     |     0.0      |     4.0      |
|  TS청산  | 20200106 | 285.0  |    0     | 289.0  |    1     |     4.0      |     8.0      |
| 콜 진입  | 20200206 | 301.4  |    1     |  0.0   |    0     |     0.0      |     8.0      |
|   손절   | 20200210 | 301.4  |    0     | 296.45 |    1     |    -4.95     |     3.05     |
| 콜 진입  | 20200929 | 309.95 |    1     |  0.0   |    0     |     0.0      |     3.05     |
|  TS청산  | 20201015 | 309.95 |    0     | 313.3  |    1     |     3.35     |     6.4      |
| 콜 진입  | 20201106 | 321.85 |    1     |  0.0   |    0     |     0.0      |     6.4      |
| 이평청산 | 20210323 | 321.85 |    0     | 408.15 |    1     |     86.3     |     92.7     |
| 콜 진입  | 20210405 | 424.05 |    1     |  0.0   |    0     |     0.0      |     92.7     |
|  TS청산  | 20210421 | 424.05 |    0     | 425.65 |    1     |     1.6      |     94.3     |
| 콜 진입  | 20210521 | 421.6  |    1     |  0.0   |    0     |     0.0      |     94.3     |
|  TS청산  | 20210709 | 421.6  |    0     | 426.25 |    1     |     4.65     |    98.95     |
| 콜 진입  | 20210806 | 433.55 |    1     |  0.0   |    0     |     0.0      |    98.95     |
|   손절   | 20210810 | 433.55 |    0     | 429.0  |    1     |    -4.55     |     94.4     |
| 콜 진입  | 20230328 | 317.45 |    1     |  0.0   |    0     |     0.0      |     94.4     |
|  TS청산  | 20230406 | 317.45 |    0     | 319.75 |    1     |     2.3      |     96.7     |
| 콜 진입  | 20230918 | 342.95 |    1     |  0.0   |    0     |     0.0      |     96.7     |
|   손절   | 20230921 | 342.95 |    0     | 334.2  |    1     |    -8.75     |    87.95     |
| 콜 진입  | 20240202 | 354.05 |    1     |  0.0   |    0     |     0.0      |    87.95     |
|   손절   | 20240205 | 354.05 |    0     | 349.25 |    1     |     -4.8     |    83.15     |
| 최종평가 | 20240307 |  0.0   |    0     |  0.0   |    0     |     0.0      |    83.15     |
+----------+----------+--------+----------+--------+----------+--------------+--------------+
일자: 20180731~20240307
총수익(pt): 106.2, 총손실(pt): -23.05, 최대연속손실(pt): -13.55
수익/진입 횟수: 7 / 11, 승율: 63.64%, 손익비: 4.61
최종평가손익(pt): 83.15, 연평균손익(pt): 14.46
최종평가손익(원): 20,787,499, 연평균손익(원): 3,615,217
'''
